...
# dau vao cua anh la kich thuoc bao nhieu khi dua vao mo hin cnn, co bao nhieu layers, dau ra cua no
# tim hieu ve tham so dau vao: hyper parameters (sieu tham so) -> dua vao chuan bi cho training
# tim hieu ve ham mat mat (loss function, activation function - ham kich hoat), phuong phap toi uu - optimization method
